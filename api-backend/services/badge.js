...
const createBadge = (resume, profileName) => {
  ...
  <style>
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 118.73509959046261;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <rect data-testid="card-bg" x="0.5" y="0.5" rx="4.5" height="99%" stroke="#E4E2E2" width="494" fill="#${bg_color}" stroke-opacity="0"/>

      
    <g data-testid="card-title" transform="translate(25, 35)">
      <g transform="translate(0, 0)">
    <text x="0" y="0" class="header" data-testid="header">${profileName} ${platziTitle}</text>
  </g>
    </g>
  ...
  <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
    ...
    <text class="stat bold" x="25" y="12.5">Total Points:</text>
    <text class="stat" x="200" y="12.5" data-testid="issues">${platziPoints}</text>
  </g>
  ...
  <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
    ...
    <text class="stat bold" x="25" y="12.5">Total Questions:</text>
    <text class="stat" x="200" y="12.5" data-testid="contribs">${platziQuestions}</text>
  </g>
  </g><g transform="translate(0, 100)">
  <g class="stagger" style="animation-delay: 1050ms" transform="translate(25, 25)">
    
  <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
    <path fill-rule="evenodd" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z"/>
  </svg>

    <text class="stat bold" x="25" y="12.5">Total Answers:</text>
    <text class="stat" x="200" y="12.5" data-testid="contribs">${platziAnswers}</text>
  </g>
  </g>
  </svg> 
